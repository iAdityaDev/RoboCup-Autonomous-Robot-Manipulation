classdef SplitLayer1005 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'best.coder.SplitLayer1005';
        end
    end
    ...
    methods
        ...
        function [x_model_13_Split_o_1, x_model_13_Split_out] = predict(this, x_model_13_cv1_act_M)
            ...
            x_model_13_cv1_act_M = best.ops.permuteInputVar(x_model_13_cv1_act_M, [4 3 1 2], 4);
            ...
            x_model_13_Split_o_1 = best.ops.permuteOutputVar(x_model_13_Split_o_1, [3 4 2 1], 4);
            x_model_13_Split_out = best.ops.permuteOutputVar(x_model_13_Split_out, [3 4 2 1], 4);
        ...
        function [x_model_13_Split_o_1, x_model_13_Split_out, x_model_13_Split_o_1NumDims1022, x_model_13_Split_outNumDims1023] = SplitGraph1020(this, x_model_13_cv1_act_M, x_model_13_cv1_act_MNumDims, Training)
            ...
            % Split:
            [x_model_13_Split_out, x_model_13_Split_o_1, x_model_13_Split_outNumDims, x_model_13_Split_o_1NumDims] = best.ops.onnxSplit(x_model_13_cv1_act_M, 1, this.Vars.SplitSplit1021, 0, x_model_13_cv1_act_MNumDims);
