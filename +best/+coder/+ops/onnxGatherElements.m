...
X               = best.coder.ops.extractIfDlarray(X_);
ONNXIndices     = best.coder.ops.extractIfDlarray(ONNXIndices_);
ONNXAxis        = best.coder.ops.extractIfDlarray(ONNXAxis_);
numDimsX        = best.coder.ops.extractIfDlarray(numDimsX_);
numDimsIndices  = best.coder.ops.extractIfDlarray(numDimsIndices_);
