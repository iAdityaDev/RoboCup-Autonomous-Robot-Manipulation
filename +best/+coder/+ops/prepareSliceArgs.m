...
Starts = best.coder.ops.extractIfDlarray(Starts_);
Ends = best.coder.ops.extractIfDlarray(Ends_);
Axes_ = best.coder.ops.extractIfDlarray(Axes__);
Steps_ = best.coder.ops.extractIfDlarray(Steps__);
