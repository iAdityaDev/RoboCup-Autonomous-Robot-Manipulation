classdef SplitLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = best.coder.SplitLayer1000(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = best.SplitLayer1000(cgInstance.Name);
    ...
    methods
        ...
        function [x_model_2_Split_ou_1, x_model_2_Split_outp] = predict(this, x_model_2_cv1_act_Mu__)
            ...
            x_model_2_cv1_act_Mu = best.coder.ops.permuteInputVar(x_model_2_cv1_act_Mu_, [4 3 1 2], 4);
            ...
            x_model_2_Split_ou_1_ = best.coder.ops.permuteOutputVar(x_model_2_Split_ou_1__, [3 4 2 1], 4);
            x_model_2_Split_outp_ = best.coder.ops.permuteOutputVar(x_model_2_Split_outp__, [3 4 2 1], 4);
        ...
        function [x_model_2_Split_ou_1, x_model_2_Split_outp, x_model_2_Split_ou_1NumDims1002, x_model_2_Split_outpNumDims1003] = SplitGraph1000(this, x_model_2_cv1_act_Mu, x_model_2_cv1_act_MuNumDims, Training)
            ...
            % Split:
            [x_model_2_Split_outp, x_model_2_Split_ou_1, x_model_2_Split_outpNumDims, x_model_2_Split_ou_1NumDims] = best.coder.ops.onnxSplit(x_model_2_cv1_act_Mu, 1, this.Vars.SplitSplit1001, 0, coder.const(x_model_2_cv1_act_MuNumDims));
