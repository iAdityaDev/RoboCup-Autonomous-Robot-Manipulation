...
Starts = best2.coder.ops.extractIfDlarray(Starts_);
Ends = best2.coder.ops.extractIfDlarray(Ends_);
Axes_ = best2.coder.ops.extractIfDlarray(Axes__);
Steps_ = best2.coder.ops.extractIfDlarray(Steps__);
