classdef Transpose_To_AddLayer1011 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = best2.coder.Transpose_To_AddLayer1011(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = best2.Transpose_To_AddLayer1011(cgInstance.Name);
    ...
    methods
        ...
        function [x_model_22_m_0_m__15] = predict(this, x_model_22_m_0_m__23__, x_model_22_m_0_m__24__, x_model_22_m_0_m__25__, x_model_22_m_0_m__28__, x_model_22_m_0_m__23NumDims__, x_model_22_m_0_m__24NumDims__, x_model_22_m_0_m__25NumDims__)
            ...
            x_model_22_m_0_m__23 = best2.coder.ops.permuteInputVar(x_model_22_m_0_m__23_, ['as-is'], 0);
            x_model_22_m_0_m__24 = best2.coder.ops.permuteInputVar(x_model_22_m_0_m__24_, ['as-is'], 0);
            x_model_22_m_0_m__25 = best2.coder.ops.permuteInputVar(x_model_22_m_0_m__25_, ['as-is'], 0);
            x_model_22_m_0_m__28 = best2.coder.ops.permuteInputVar(x_model_22_m_0_m__28_, [4 3 1 2], 4);
            ...
            x_model_22_m_0_m__15_ = best2.coder.ops.permuteOutputVar(x_model_22_m_0_m__15__, [3 4 2 1], 4);
        ...
        function [x_model_22_m_0_m__15, x_model_22_m_0_m__15NumDims1053] = Transpose_To_AddGraph1050(this, x_model_22_m_0_m__23, x_model_22_m_0_m__24, x_model_22_m_0_m__25, x_model_22_m_0_m__28, x_model_22_m_0_m__23NumDims, x_model_22_m_0_m__24NumDims, x_model_22_m_0_m__25NumDims, x_model_22_m_0_m__28NumDims, Training)
            ...
            % Transpose:
            [perm1024, x_model_22_m_0_m__27NumDims] = best2.coder.ops.prepareTransposeArgs(this.Vars.TransposePerm1051, coder.const(x_model_22_m_0_m__23NumDims));
            if isempty(perm1024)
                x_model_22_m_0_m__27 = x_model_22_m_0_m__23;
            else
                x_model_22_m_0_m__27 = permute(best2.coder.ops.extractIfDlarray(x_model_22_m_0_m__23), perm1024);
            end

            % MatMul:
            [x_model_22_m_0_m__17, x_model_22_m_0_m__17NumDims] = best2.coder.ops.onnxMatMul(x_model_22_m_0_m__27, x_model_22_m_0_m__24, coder.const(x_model_22_m_0_m__27NumDims), coder.const(x_model_22_m_0_m__24NumDims));
            ...
            % Softmax:
            [dim11025, dim21026, origSize1027, x_model_22_m_0_m__22NumDims] = best2.coder.ops.prepareSoftmaxArgs(x_model_22_m_0_m__18, 3, coder.const(x_model_22_m_0_m__18NumDims));
            Y11028 = reshape(x_model_22_m_0_m__18, dim11025, dim21026);
            Y21029 = softmax(dlarray(single(Y11028)), 'DataFormat', 'CB');
            x_model_22_m_0_m__22 = reshape(best2.coder.ops.extractIfDlarray(Y21029), origSize1027);

            % Transpose:
            [perm1030, x_model_22_m_0_m__26NumDims] = best2.coder.ops.prepareTransposeArgs(this.Vars.TransposePerm1052, coder.const(x_model_22_m_0_m__22NumDims));
            if isempty(perm1030)
                x_model_22_m_0_m__26 = x_model_22_m_0_m__22;
            else
                x_model_22_m_0_m__26 = permute(best2.coder.ops.extractIfDlarray(x_model_22_m_0_m__22), perm1030);
            end

            % MatMul:
            [x_model_22_m_0_m__16, x_model_22_m_0_m__16NumDims] = best2.coder.ops.onnxMatMul(x_model_22_m_0_m__25, x_model_22_m_0_m__26, coder.const(x_model_22_m_0_m__25NumDims), coder.const(x_model_22_m_0_m__26NumDims));

            % Reshape:
            [shape1031, x_model_22_m_0_m__19NumDims] = best2.coder.ops.prepareReshapeArgs(x_model_22_m_0_m__16, this.Vars.x_model_10_m_m_0__2, coder.const(x_model_22_m_0_m__16NumDims), 0);
