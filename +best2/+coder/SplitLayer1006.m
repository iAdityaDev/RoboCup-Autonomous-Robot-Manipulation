classdef SplitLayer1006 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = best2.coder.SplitLayer1006(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = best2.SplitLayer1006(cgInstance.Name);
    ...
    methods
        ...
        function [x_model_16_Split_o_1, x_model_16_Split_out] = predict(this, x_model_16_cv1_act_M__)
            ...
            x_model_16_cv1_act_M = best2.coder.ops.permuteInputVar(x_model_16_cv1_act_M_, [4 3 1 2], 4);
            ...
            x_model_16_Split_o_1_ = best2.coder.ops.permuteOutputVar(x_model_16_Split_o_1__, [3 4 2 1], 4);
            x_model_16_Split_out_ = best2.coder.ops.permuteOutputVar(x_model_16_Split_out__, [3 4 2 1], 4);
        ...
        function [x_model_16_Split_o_1, x_model_16_Split_out, x_model_16_Split_o_1NumDims1026, x_model_16_Split_outNumDims1027] = SplitGraph1024(this, x_model_16_cv1_act_M, x_model_16_cv1_act_MNumDims, Training)
            ...
            % Split:
            [x_model_16_Split_out, x_model_16_Split_o_1, x_model_16_Split_outNumDims, x_model_16_Split_o_1NumDims] = best2.coder.ops.onnxSplit(x_model_16_cv1_act_M, 1, this.Vars.SplitSplit1025, 0, coder.const(x_model_16_cv1_act_MNumDims));
