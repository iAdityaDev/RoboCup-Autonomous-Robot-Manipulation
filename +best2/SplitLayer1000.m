classdef SplitLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'best2.coder.SplitLayer1000';
        end
    end
    ...
    methods
        ...
        function [x_model_2_Split_ou_1, x_model_2_Split_outp] = predict(this, x_model_2_cv1_act_Mu)
            ...
            x_model_2_cv1_act_Mu = best2.ops.permuteInputVar(x_model_2_cv1_act_Mu, [4 3 1 2], 4);
            ...
            x_model_2_Split_ou_1 = best2.ops.permuteOutputVar(x_model_2_Split_ou_1, [3 4 2 1], 4);
            x_model_2_Split_outp = best2.ops.permuteOutputVar(x_model_2_Split_outp, [3 4 2 1], 4);
        ...
        function [x_model_2_Split_ou_1, x_model_2_Split_outp, x_model_2_Split_ou_1NumDims1002, x_model_2_Split_outpNumDims1003] = SplitGraph1000(this, x_model_2_cv1_act_Mu, x_model_2_cv1_act_MuNumDims, Training)
            ...
            % Split:
            [x_model_2_Split_outp, x_model_2_Split_ou_1, x_model_2_Split_outpNumDims, x_model_2_Split_ou_1NumDims] = best2.ops.onnxSplit(x_model_2_cv1_act_Mu, 1, this.Vars.SplitSplit1001, 0, x_model_2_cv1_act_MuNumDims);
